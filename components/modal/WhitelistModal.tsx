...
export function SuccessModalContent() {
  return (
    <>
      <img src="/images/verified.png" alt="Check" style={{ width: "100px", height: "100px", margin: "0 auto" }} />
      <h2
        style={{
          fontSize: "22px",
          fontWeight: 600,
      ...
      <div style={{ display: "flex", gap: "16px", margin: "24px 0" }}>
        <MainActionButton label="Follow on X" handleClick={() => window.open("https://x.com/BitVaultFinance", "_blank")} />
        <MainActionButton label="Join Telegram" handleClick={() => window.open("https://t.me/bitvaultTG", "_blank")} />
