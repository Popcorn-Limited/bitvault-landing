        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "16px", margin: "24px 0" }}>
          ...
          <div style={{ gridColumn: "span 1" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "8px" }}>
              <AssetButton label="BTC" symbol="BTC" active={assets.btc} onClick={() => setAssets({ ...assets, btc: !assets.btc })} />
            ...
            <span style={{ display: "flex", alignItems: "center" }}>
              <div style={{ width: "24px", height: "24px" }}>
                <Checkbox
                  ...
                  className={`group block size-4 rounded border cursor-pointer ${newsletter ? "bg-primaryGold" : ""}`}
                />
              </div>
...
function AssetButton({ label, symbol, active, onClick }: { label: string, symbol: string, active: boolean, onClick: () => void }) {
  return (
    <div
    ...
    >
      <span style={{ display: "flex", alignItems: "center", gap: "8px" }}>
        <img src={`/images/${symbol.toLowerCase()}.svg`} alt={label} style={{ width: "18px", height: "18px" }} />
